            ...
            {editingId === a.id ? (
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start' }}>
                ...
                <div style={{ display: 'flex', gap: '4px' }}>
                  ...
                  {idx < activities.length - 1 && <button className="btn-gold" onClick={() => handleMove(a.id, 'down')} style={{ width: '32px', height: '32px', padding: '0', fontSize: '14px', display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: 'auto' }}>↓</button>}
              ...
              {editingId === accommodation.id ? (
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start' }}>
                  ...
                  <div style={{ display: 'flex', gap: '4px' }}>
                    ...
                    <button className="btn-danger" onClick={() => handleDelete('accommodations', accommodation.id)} style={{ width: '32px', height: '32px', padding: '0', fontSize: '14px', display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: 'auto' }}>✕</button>
                  </div>
                </div>
              )}
            </div>
